...
const usePredictiveEngagementFormatter = () => {
    const getPredictions = (predictionResponse: EngagementPredictionResponse | null) => {
        ...
        const { views, joins, engagement_score, dropoff_rate } = predictionResponse.engagement_prediction.predictive_engagement.summary.key_metrics;
        const predictions: StatData[] = [
            { icon: '👥', icon_url: 'src/assets/icons/group_add.svg', label: 'Views', translation_key: 'user_segments.metrics.views', value: views },
            // { icon: '📊', icon_url: 'src/assets/icons/account_balance_wallet.svg', label: 'Revenue', translation_key: 'user_segments.metrics.revenue', value: expected_revenue },
            { icon: '💎', icon_url: 'src/assets/icons/groups.svg', label: 'Joins', translation_key: 'user_segments.metrics.joins', value: joins },
            { icon: '💎', icon_url: 'src/assets/icons/flare.svg', label: 'Engagement', translation_key: 'user_segments.metrics.engagement', value: engagement_score },
            { icon: '💎', icon_url: 'src/assets/icons/arrow_outward_down.svg', label: 'Drop-off Rate', translation_key: 'user_segments.metrics.drop_off_rate', value: dropoff_rate },
        ];
        return predictions;
    }
